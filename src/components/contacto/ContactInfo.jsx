      ...
      <div className="contact-info-inner">
        ...
        <div className="contact-info-facts">
          <div className="contact-info-fact">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" className="contact-info-fact-icon">
            ...
            <div className="contact-info-fact-text">
              {LOCATIONS.map((loc, idx) => (
                <span key={loc.city}>
                  <b>{loc.city}</b> · {loc.address}
                  {idx < LOCATIONS.length - 1 && <br />}
                </span>
              ))}
            </div>
          </div>
          <div className="contact-info-fact contact-info-fact--center">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" className="contact-info-fact-icon">
